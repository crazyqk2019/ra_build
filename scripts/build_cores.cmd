...
:build_pcsx2
SETLOCAL
SET "cmake_params=-DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DLIBRETRO=ON -DCMAKE_C_FLAGS_RELEASE="/utf-8" -DCMAKE_CXX_FLAGS_RELEASE="/utf-8""
CALL build_use_cmake.cmd "PCSX2" "pcsx2" "." "vc_build\libretro"
ENDLOCAL
EXIT /B %ERRORLEVEL%
